...
<head>
    <meta charset="UTF-8">
    <title>La Liga Española de Fútbol</title>
    <link rel="stylesheet" href="style.css">
    <link rel="icon" href="LaLiga.png" type="image/png">
</head>

<body>
    <div class="container">
        <h1>La Liga Española de Fútbol</h1>
        <img src="LaLiga.png" alt="La Liga Española de Fútbol" class="logo">
