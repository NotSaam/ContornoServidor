...
<body>
    <form action="ex8.php" method="POST">
        ...
        <input type="number" id="num1" name="apuesta[num1]">

        <br>
        <label for="num2">Numero 2: </label><br>
        <input type="number" id="num2" name="apuesta[num2]">
        <br>
        <label for="num3">Numero 3: </label><br>
        <input type="number" id="num3" name="apuesta[num3]">

        <br>
        <label for="num4">Numero 4: </label><br>
        <input type="number" id="num4" name="apuesta[num4]">

        <br>
        <label for="num5">Numero 5: </label><br>
        <input type="number" id="num5" name="apuesta[num5]">
